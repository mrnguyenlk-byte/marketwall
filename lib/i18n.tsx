...
const dict: Dict = {
  ...
  "sector.consumer": { vi: "Tiêu dùng", en: "Consumer" },
  "sector.insurance": { vi: "Bảo hiểm", en: "Insurance" },
  "sector.chemicals": { vi: "Hóa chất", en: "Chemicals" },
  "sector.healthcare": { vi: "Y tế", en: "Healthcare" },
